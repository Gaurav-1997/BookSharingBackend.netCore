...
namespace BookSharing.Controllers
{
    ...
    public class CartItemsController : ControllerBase
    {
        ...
        public CartItemsController(BookSharingContext context)
        {
            _context = context;
        }
        ...
        //public async Task<ActionResult<CartItem>> GetCartItems(int cartId)
        public async Task<ActionResult<IEnumerable<CartItem>>> GetCartItems(int cartId)
        {
            ...
            //_context.Entry(cartItems)
            //    .Collection(cit => cit.).Load();
